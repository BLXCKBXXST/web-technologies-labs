...
% --- Скриншот: статус MariaDB ---
\begin{figure}[h]
  \centering
  \includegraphics{img/06_mariadb_status}
  \caption{Сервис MariaDB активен и база данных wordpress создана}
  \label{fig:mariadb_status}
\end{figure}
...
% --- Скриншот: мастер установки WordPress ---
\begin{figure}[h]
  \centering
  \includegraphics{img/08_wp_installer}
  \caption{Мастер установки WordPress в браузере на ВМ desktop1}
  \label{fig:wp_installer}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics{img/10_wp_admin_panel}
  \caption{Панель администратора WordPress после входа}
  \label{fig:wp_admin}
\end{figure}
