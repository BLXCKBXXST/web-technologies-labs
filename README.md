...
> Папка добавляется именно в **глобальные** настройки VirtualBox (Файл → Настройки), а не в настройки конкретной ВМ — тогда она автоматически доступна во всех ВМ без дополнительной настройки каждого клона.
