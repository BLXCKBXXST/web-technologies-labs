...
> ⚠️ **Важно**
>
> Методички преподавателя используют другие версии ВМ и зависимостей — все скрипты и LaTeX-отчёты в этом репозитории реализованы на **Ubuntu 20.04** с зависимостями под эту версию.  
> LaTeX-отчёты написаны в соответствии с требованиями методички, но фактическая реализация может отличаться от методички — это нормально.
