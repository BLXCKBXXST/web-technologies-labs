...
> **⚠️ Шаги 01, 06, 07, 14, 15** — выполняются вручную,
> скрипт только напомнит что делать. Шаг 09 запускает `dpkg-reconfigure` автоматически.
...
scp *.png user@192.168.N.1:/path/to/lab4/latex-report/img/
```
