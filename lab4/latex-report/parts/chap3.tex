...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{img/08_sysctl_ipforward.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{img/09_iptables_persistent_dialog.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{img/10_iptables_rules.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{img/11_dhcp_interfaces.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{img/12_dhcpd_conf.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{img/13_dhcp_status.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.75\textwidth]{img/14_desktop_dhcp_ip.png}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{img/15_ping_yaru_desktop.png}
