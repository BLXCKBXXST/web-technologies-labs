...
# 09 — подсказка: этот диалог был при установке, воспроизвести нельзя.
# Можно показать dpkg-reconfigure как замену.
echo ""
echo "========================================"
echo "  [Скриншот 09] Диалог iptables-persistent"
echo "  Файл: img/09_iptables_persistent_dialog.png"
echo "  • Команда вызовет диалог подтверждения — сделай скриншот на нём."
echo "========================================"
...
echo "  • Перейди на Desktop1 → убедись что IP получен автоматически"
echo "    (настройки сети или ip a)"
echo "========================================"
read -rp "  ✔ Сделай скриншот и нажми Enter..."
