...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{img/05_nginx_conf}
...
\texttt{admin@\cfgDomain} и пароль.

% — Скриншот: вывод seafile.sh start + seahub.sh start —
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{img/06_seafile_start}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{img/07_seafile_service}
...
\texttt{admin@\cfgDomain}.

% — Скриншот: страница входа Seafile в браузере —
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{img/08_seafile_web_login}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{img/09_seafile_web_library}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.85\textwidth]{img/10_seafile_client_sync}
