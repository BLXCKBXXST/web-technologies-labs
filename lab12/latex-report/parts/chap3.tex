...
\begin{lstlisting}
TODO: URL форка Codepen для блока 1.1
\end{lstlisting}
...
Готовый форк pen-а на Codepen:
\begin{lstlisting}
TODO: URL форка Codepen для блока 1.2
\end{lstlisting}
...
Готовый форк pen-а на Codepen:
\begin{lstlisting}
TODO: URL форка Codepen для блока 2.1
\end{lstlisting}
...
Готовый форк pen-а на Codepen:
\begin{lstlisting}
TODO: URL форка Codepen для блока 2.2
\end{lstlisting}
...
\hline
1.1 & Теги для разметки текста и атрибуты            & TODO \\
1.2 & Списки и таблицы                                & TODO \\
2.1 & Селекторы и свойства                            & TODO \\
2.2 & Оформление текстовых блоков при помощи CSS      & TODO \\
\hline
\end{tabular}
\end{center}
